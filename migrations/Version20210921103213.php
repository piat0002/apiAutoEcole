 ...
 */
final class Version20210921103213 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE eleve (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, nom VARCHAR(255) NOT NULL, prenom VARCHAR(255) NOT NULL, rue VARCHAR(255) NOT NULL, ville VARCHAR(255) NOT NULL, cp VARCHAR(255) NOT NULL, birthdate TIME NOT NULL)');
        $this->addSql('CREATE TABLE note (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, seance_id INTEGER DEFAULT NULL, note INTEGER DEFAULT NULL)');
        ...
        $this->addSql('CREATE TABLE ordre (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, question_id INTEGER DEFAULT NULL, serie_id INTEGER DEFAULT NULL, numero_ordre INTEGER NOT NULL)');
        ...
        $this->addSql('CREATE TABLE serie (id INTEGER PRIMARY KEY AUTOINCREMENT NOT NULL, cd_id INTEGER DEFAULT NULL, numero INTEGER NOT NULL)');
